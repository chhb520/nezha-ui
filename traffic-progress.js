const SCRIPT_VERSION = 'v20250819';
      ...
      if (existing) {
        ...
        newElement.innerHTML = `
          ...
          <div class="relative h-1.5">
            <!-- 底色：浅色深灰 #d1d5db，深色深灰 #1e293b -->
            <div class="absolute inset-0 rounded-full" style="background-color:#d1d5db;"></div>
            <div class="absolute inset-0 rounded-full dark:block hidden" style="background-color:#1e293b;"></div>
            <!-- 已用流量条 -->
